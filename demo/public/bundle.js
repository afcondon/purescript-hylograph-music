...
(() => {
  ...
  // output/PSD3.Music.Internal.FFI/foreign.js
  var createAudioContext = function() {
    return new (window.AudioContext || window.webkitAudioContext)();
  };
  var scheduleNote = function(ctx) {
  ...
  // output/Anscombe.Audio/index.js
  var traverse_2 = /* @__PURE__ */ traverse_(applicativeEffect)(foldableArray);
  var yToPitch = function(y) {
    return 200 + y * 50;
  };
  var schedulePoint = function(ctx) {
    return function(params) {
      return function(v) {
        return scheduleNote(ctx)({
          time: toNumber(v.value0) * params.noteInterval,
          frequency: yToPitch(v.value1.y),
  ...
  var cycleDuration = function(params) {
    return function(noteCount) {
      return (toNumber(noteCount) * params.noteInterval + params.cyclePause) * 1e3;
    };
  };
  var scheduleDatasetCycle = function(ctx) {
    return function(dataset) {
      return function __do2() {
        traverse_2(schedulePoint(ctx)(cycleParams))(mapWithIndex2(Tuple.create)(dataset.points))();
        return cycleDuration(cycleParams)(length(dataset.points));
      };
    };
  };

  // output/Anscombe.Data/index.js
  var compare2 = /* @__PURE__ */ compare(ordNumber);
  var datasetIV = {
    name: "IV",
    numeral: "IV",
    points: /* @__PURE__ */ sortBy(function(a2) {
      return function(b2) {
        return compare2(a2.x)(b2.x);
      };
    })([{
      x: 8,
      y: 6.58
  ...
  var allDatasets = [datasetI, datasetII, datasetIII, datasetIV];

  // output/Anscombe.Timer/foreign.js
  var setInterval = (ms) => (action2) => () => {
    return window.setInterval(action2, ms);
  };
  var clearInterval = (id2) => () => {
    window.clearInterval(id2);
  };

  // output/Anscombe.Types/index.js
  ...
  var isDatasetPlaying = function(name15) {
    return function(v) {
      ...
      if (v instanceof Playing) {
        return v.value0.dataset.name === name15;
      }
      ;
      throw new Error("Failed pattern match at Anscombe.Types (line 57, column 25 - line 59, column 40): " + [v.constructor.name]);
    };
  };
  var initialState = /* @__PURE__ */ (function() {
    return {
      playState: Idle.value,
      audioCtx: Nothing.value
    };
  })();
  var currentNoteFor = function(name15) {
    return function(v) {
      if (v instanceof Idle) {
        return Nothing.value;
      }
      ;
      if (v instanceof Playing) {
        if (v.value0.dataset.name === name15) {
          return new Just(v.value0.noteIndex);
        }
        ;
        if (otherwise) {
          return Nothing.value;
      ...
      ;
      throw new Error("Failed pattern match at Anscombe.Types (line 63, column 23 - line 67, column 27): " + [v.constructor.name]);
    };
  };
        ...
        var go2 = function($copy_v) {
          ...
          function $tco_loop(v) {
            if (v.value1.value0 instanceof Pure) {
              var v1 = goApply1(v.value0)(v.value1.value1)(pure12(v.value1.value0.value0));
    ...
    return function(k) {
      var go2 = function(f) {
        ...
        if (v instanceof Return) {
          return map17(Done.create)(pure12(v.value0));
        }
        ;
  ...
  // output/Anscombe.Component/index.js
  ...
  var ToggleDataset = /* @__PURE__ */ (function() {
    function ToggleDataset2(value0) {
      this.value0 = value0;
    }
    ;
    ToggleDataset2.create = function(value0) {
      return new ToggleDataset2(value0);
    };
    return ToggleDataset2;
  })();
  var AdvanceNote = /* @__PURE__ */ (function() {
    function AdvanceNote2() {
    }
    ;
    AdvanceNote2.value = new AdvanceNote2();
    return AdvanceNote2;
  })();
  var ScheduleNextCycle = /* @__PURE__ */ (function() {
    function ScheduleNextCycle2() {
    }
    ;
    ScheduleNextCycle2.value = new ScheduleNextCycle2();
    return ScheduleNextCycle2;
  })();
  var svgNS = "http://www.w3.org/2000/svg";
  var svgElement = function(name15) {
    return elementNS(svgNS)(name15);
  };
  var stopPlayback = function(dictMonadAff) {
    return bind3(get2)(function(state3) {
      return discard2((function() {
        if (state3.noteSubscription instanceof Just) {
          return unsubscribe2(state3.noteSubscription.value0);
        }
        ;
        if (state3.noteSubscription instanceof Nothing) {
          return pure6(unit);
        }
        ;
        throw new Error("Failed pattern match at Anscombe.Component (line 341, column 3 - line 343, column 25): " + [state3.noteSubscription.constructor.name]);
      })())(function() {
        return discard2((function() {
          if (state3.cycleSubscription instanceof Just) {
            return unsubscribe2(state3.cycleSubscription.value0);
          }
          ;
          if (state3.cycleSubscription instanceof Nothing) {
            return pure6(unit);
          }
          ;
          throw new Error("Failed pattern match at Anscombe.Component (line 345, column 3 - line 347, column 25): " + [state3.cycleSubscription.constructor.name]);
        })())(function() {
          return modify_3(function(v) {
            ...
            ;
            $46.playState = Idle.value;
            $46.noteSubscription = Nothing.value;
            $46.cycleSubscription = Nothing.value;
            return $46;
          });
        });
      });
  ...
  var renderHeader = /* @__PURE__ */ header([/* @__PURE__ */ class_("header")])([/* @__PURE__ */ h1_([/* @__PURE__ */ text("Anscombe's Quartet")]), /* @__PURE__ */ p([/* @__PURE__ */ class_("subtitle")])([/* @__PURE__ */ text("Four datasets with identical statistical properties")]), /* @__PURE__ */ p([/* @__PURE__ */ class_("stats")])([/* @__PURE__ */ text("Mean of x: 9 | Mean of y: 7.50 | Correlation: 0.816 | Regression: y = 3.00 + 0.500x")])]);
  var renderFooter = /* @__PURE__ */ footer([/* @__PURE__ */ class_("footer")])([/* @__PURE__ */ p_([/* @__PURE__ */ text("F. J. Anscombe, "), /* @__PURE__ */ em_([/* @__PURE__ */ text("Graphs in Statistical Analysis")]), /* @__PURE__ */ text(", American Statistician, 27 (February 1973), 17-21.")]), /* @__PURE__ */ p([/* @__PURE__ */ class_("tech")])([/* @__PURE__ */ text("Sonification: Y-axis maps to pitch. Click Play to hear each dataset.")])]);
  var noteEmitter = function(intervalMs) {
    return makeEmitter(function(emit) {
      return function __do2() {
        var intervalId = setInterval(intervalMs)(emit(AdvanceNote.value))();
        return clearInterval(intervalId);
      };
    });
  };
  var mkInitialState = /* @__PURE__ */ (function() {
    return {
      playState: initialState.playState,
      audioCtx: initialState.audioCtx,
      noteSubscription: Nothing.value,
      cycleSubscription: Nothing.value
    };
  })();
  var fmt = /* @__PURE__ */ toStringWith(/* @__PURE__ */ fixed(1));
  var line = function(x1) {
    return function(y1) {
      return function(x2) {
        return function(y2) {
          return svgElement("line")([attr2("x1")(fmt(x1)), attr2("y1")(fmt(y1)), attr2("x2")(fmt(x2)), attr2("y2")(fmt(y2))])([]);
        };
      };
    };
  };
  var renderPoint = function(scaleX) {
    return function(scaleY) {
      return function(highlightIdx) {
        return function(idx) {
          return function(point) {
            var isHighlighted = idx === highlightIdx;
            return svgElement("circle")([attr2("cx")(fmt(scaleX(point.x))), attr2("cy")(fmt(scaleY(point.y))), attr2("r")((function() {
              if (isHighlighted) {
                return "6";
              }
              ;
              return "4";
            })()), attr2("class")((function() {
              if (isHighlighted) {
  ...
  var tick = function(x) {
    return function(y) {
      return function(label5) {
        return svgElement("g")([])([svgElement("line")([attr2("x1")(fmt(x)), attr2("y1")(fmt(y)), attr2("x2")(fmt(x)), attr2("y2")(fmt(y + 5))])([]), svgElement("text")([attr2("x")(fmt(x)), attr2("y")(fmt(y + 18)), attr2("class")("tick-label")])([text(label5)])]);
      };
    };
  };
  var ytick = function(x) {
    return function(y) {
      return function(label5) {
        return svgElement("g")([])([svgElement("line")([attr2("x1")(fmt(x)), attr2("y1")(fmt(y)), attr2("x2")(fmt(x - 5)), attr2("y2")(fmt(y))])([]), svgElement("text")([attr2("x")(fmt(x - 10)), attr2("y")(fmt(y + 4)), attr2("class")("tick-label y-label")])([text(label5)])]);
      };
    };
  };
  var renderScatterPlot = function(dataset) {
    return function(highlightIdx) {
      var margin = {
        top: 30,
        right: 20,
      ...
      var plotWidth = 280 - margin.left - margin.right;
      var scaleX = function(x) {
        return margin.left + x / 20 * plotWidth;
      };
      var plotHeight = 280 - margin.top - margin.bottom;
      var scaleY = function(y) {
        return margin.top + plotHeight - y / 14 * plotHeight;
      };
      return svgElement("svg")([attr2("viewBox")("0 0 " + (show2(280) + (" " + show2(280)))), attr2("class")("scatter-plot")])([svgElement("text")([attr2("x")(fmt(margin.left + 15)), attr2("y")(fmt(margin.top + 20)), attr2("class")("numeral")])([text(dataset.numeral)]), svgElement("g")([attr2("class")("axis")])([line(margin.left)(margin.top)(margin.left)(margin.top + plotHeight), line(margin.left)(margin.top + plotHeight)(margin.left + plotWidth)(margin.top + plotHeight), tick(scaleX(5))(margin.top + plotHeight)("5"), tick(scaleX(10))(margin.top + plotHeight)("10"), tick(scaleX(15))(margin.top + plotHeight)("15"), tick(scaleX(20))(margin.top + plotHeight)("20"), ytick(margin.left)(scaleY(5))("5"), ytick(margin.left)(scaleY(10))("10")]), svgElement("g")([attr2("class")("points")])(mapWithIndex2(renderPoint(scaleX)(scaleY)(highlightIdx))(dataset.points))]);
    };
  };
  var renderDatasetCard = function(state3) {
    return function(dataset) {
      var isPlaying = isDatasetPlaying(dataset.name)(state3.playState);
      var highlightIdx = fromMaybe(-1 | 0)(currentNoteFor(dataset.name)(state3.playState));
      return div2([class_("dataset-card")])([renderScatterPlot(dataset)(highlightIdx), div2([class_("controls")])([button([class_((function() {
        if (isPlaying) {
          return "stop-btn";
        }
        ;
        ...
        return new ToggleDataset(dataset);
      })])([text((function() {
        if (isPlaying) {
          return "Stop";
        }
  ...
  var renderQuartet = function(state3) {
    return div2([class_("quartet-grid")])(mapFlipped2(allDatasets)(renderDatasetCard(state3)));
  };
  var render = function(state3) {
    return div2([class_("anscombe-container")])([renderHeader, renderQuartet(state3), renderFooter]);
  };
  var cycleEmitter = function(cycleDurationMs) {
    return makeEmitter(function(emit) {
      return function __do2() {
        var intervalId = setInterval(cycleDurationMs)(emit(ScheduleNextCycle.value))();
        return clearInterval(intervalId);
      };
    });
  };
  var startPlayback = function(dictMonadAff) {
    var stopPlayback1 = stopPlayback(dictMonadAff);
    var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
    return function(dataset) {
      return discard2(stopPlayback1)(function() {
        return bind3(get2)(function(state3) {
          return bind3((function() {
            if (state3.audioCtx instanceof Just) {
              return pure6(state3.audioCtx.value0);
            }
            ;
            if (state3.audioCtx instanceof Nothing) {
              return liftEffect7(createAudioContext);
            }
            ;
            throw new Error("Failed pattern match at Anscombe.Component (line 315, column 10 - line 317, column 45): " + [state3.audioCtx.constructor.name]);
          })())(function(ctx) {
            return bind3(liftEffect7(scheduleDatasetCycle(ctx)(dataset)))(function(cycleDuration2) {
              var noteIntervalMs = cycleParams.noteInterval * 1e3;
              return bind3(subscribe2(noteEmitter(noteIntervalMs)))(function(noteSubId) {
                return bind3(subscribe2(cycleEmitter(cycleDuration2)))(function(cycleSubId) {
                  return modify_3(function(v) {
                    var $55 = {};
                    for (var $56 in v) {
                    ...
                    ;
                    $55.playState = new Playing({
                      dataset,
                      noteIndex: 0
                    });
                    $55.audioCtx = new Just(ctx);
                    $55.noteSubscription = new Just(noteSubId);
                    $55.cycleSubscription = new Just(cycleSubId);
                    return $55;
                  });
                });
              });
  ...
  var handleAction = function(dictMonadAff) {
    var stopPlayback1 = stopPlayback(dictMonadAff);
    var startPlayback1 = startPlayback(dictMonadAff);
    var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
    return function(v) {
      ...
      ;
      if (v instanceof ToggleDataset) {
        return bind3(get2)(function(state3) {
          if (state3.playState instanceof Playing && state3.playState.value0.dataset.name === v.value0.name) {
            return stopPlayback1;
          }
          ;
          return startPlayback1(v.value0);
        });
      }
      ;
      if (v instanceof AdvanceNote) {
        return bind3(get2)(function(state3) {
          if (state3.playState instanceof Idle) {
            return pure6(unit);
          }
          ;
          if (state3.playState instanceof Playing) {
            var noteCount = length(state3.playState.value0.dataset.points);
            var nextIdx = mod2(state3.playState.value0.noteIndex + 1 | 0)(noteCount);
            return modify_3(function(v1) {
              ...
              ;
              $63.playState = new Playing({
                dataset: state3.playState.value0.dataset,
                noteIndex: nextIdx
              });
              return $63;
            });
          ...
          ;
          throw new Error("Failed pattern match at Anscombe.Component (line 287, column 5 - line 292, column 71): " + [state3.playState.constructor.name]);
        });
      }
      ;
      if (v instanceof ScheduleNextCycle) {
        return bind3(get2)(function(state3) {
          if (state3.playState instanceof Playing && state3.audioCtx instanceof Just) {
            return bind3(liftEffect7(scheduleDatasetCycle(state3.audioCtx.value0)(state3.playState.value0.dataset)))(function() {
              return pure6(unit);
            });
          }
          ;
      ...
      ;
      throw new Error("Failed pattern match at Anscombe.Component (line 273, column 16 - line 301, column 18): " + [v.constructor.name]);
    };
  };
